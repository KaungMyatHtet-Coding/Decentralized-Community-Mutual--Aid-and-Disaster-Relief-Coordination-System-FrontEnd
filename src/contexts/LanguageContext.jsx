...
const translations = {
  en: {
    ...
    deliveryReviewsTitle: "Delivery Reviews",
    deliveryReviewsDesc: "Review volunteer delivery reports, verify proof photos, and deduct stock upon approval.",
  ...
  my: {
    ...
    deliveryReviewsTitle: "ပို့ဆောင်မှု စစ်ဆေးချက်များ",
    deliveryReviewsDesc: "စေတနာ့ဝန်ထမ်းများ၏ ပို့ဆောင်မှု မှတ်တမ်းနှင့် ဓာတ်ပုံများကို စစ်ဆေး အတည်ပြုရန်။",
